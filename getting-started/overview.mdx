...
5. [Add custom actions](/getting-started/adding-custom-actions) to your columns so you have more flexibility manipulating your data.
6. [Submit data](/getting-started/submitting-to-a-backend) to your backend using our onSubmit hook.
