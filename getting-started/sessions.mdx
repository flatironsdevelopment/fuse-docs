...
A **session** in Fuse allows you to launch the importer by generating a session token, either on your backend for enhanced security or directly in the frontend for simpler implementations. Depending on your needs, you can choose between two options:
...
<Tabs>
  ...
  <Tab title="Ruby">
    ...
    post '/api/getSessionToken' do
      ...
      template_slug = request_body['templateSlug']
      ...
      request.body = { templateSlug: template_slug, metadata: metadata }.to_json

      response = http.request(request)
      if response.code == '200'
        { sessionToken: JSON.parse(response.body)['sessionToken'] }.to_json
      else
        status 500
  ...
  <Tab title="Python">
    ...
    def get_session_token():
        ...
        try:
            ...
            return jsonify({'sessionToken': response.json().get('sessionToken')})
  ...
  <Tab title="Java">
    ...
    public class SessionController {
        ...
        public Map<String, String> getSessionToken(@RequestBody Map<String, Object> requestBody) {
            String templateSlug = (String) requestBody.get("templateSlug");
            ...
            body.put("templateSlug", templateSlug);
            ...
            if (response.getStatusCode().is2xxSuccessful()) {
                ...
                result.put("sessionToken", (String) response.getBody().get("sessionToken"));
                return result;
            } else {
  ...
  <Tab title="PHP">
    ...
    Route::post('/api/getSessionToken', function (Request $request) {
        $templateSlug = $request->input('templateSlug');
        $metadata = [ 'user_id' => 123 ];
        ...
        if ($response->successful()) {
            return response()->json(['sessionToken' => $response['sessionToken']]);
        } else {
    ...
    export class ImporterComponent {
      ...
      getSessionToken() {
        return this.http.post('/api/getSessionToken', {
          templateSlug: 'YOUR_TEMPLATE_SLUG',
          metadata: {}
        }).toPromise().then((res: any) => res.sessionToken);
      }
